...
#
# This script can serve as a template for equilibrating a fluid, single material
# planet, with a chosen mass and radius.
...
mPlanet = 250e3           # Total (and conserved) planet mass (kg)
